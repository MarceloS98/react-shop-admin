          ...
          <>
            ...
            <Disclosure.Panel className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <Disclosure.Button as="button" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" onClick={() => auth.logout}>
                  Logout
                </Disclosure.Button>
              </div>
              <div className="pt-4 pb-3 border-t border-gray-700">
                ...
                <div className="mt-3 px-2 space-y-1">
                  <Disclosure.Button as="button" onClick={() => auth.logout} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">
                    Logout
                  </Disclosure.Button>
                </div>
              </div>
